...
const save = () => {
  form.put(route("status.update", props.data.id), {
    onSuccess: () => {
      emits("close");
      form.reset();
    },
    ...
    >
      ...
      <div class="mt-5 space-y-4">
        ...
        <InputGroup
          ...
          v-model="form.slug"
        />
        <InputGroup label="Accent Color" input-id="color">
        ...
        <InputGroup label="Description" input-id="description">
          <textarea
            id="Description"
