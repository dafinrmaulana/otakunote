  ...
  <AuthenticatedLayout @click:add-btn="isModalCreateOpen = true">
    <section class="flex w-full justify-between items-center">
      <div class="flex gap-3">
        ...
        <h1 class="font-bold text-2xl">{{ props.status.name }}</h1>
      </div>
    ...
    <p class="opacity-50 text-sm mt-3" v-if="props.status.description !== null">
    ...
    <section class="w-full mt-3">
      ...
      >
        ...
        <TransitionGroup name="list">
          <div
            v-for="series in props.status.series"
      ...
      >
        <TransitionGroup name="list">
          <template v-for="series in props.status.series" :key="series.id">
